...
/**
 * The abstract model of a referenced policy set.
 *
 * @author Quentin Ligier
 **/
public abstract class ReferencedPolicySet {
     ...
     */
    @Nullable
    public abstract List<@NonNull Role> getRoles();

    /**
     * Returns the list of targeted policies. It shall not be an empty list.
     */
    public abstract List<@NonNull ReferencedPolicy> getPolicies();
}
