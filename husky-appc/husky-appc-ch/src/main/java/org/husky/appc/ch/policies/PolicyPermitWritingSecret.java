...
/**
 * The referenced policy 'permit writing secret'.
 *
 * @author Quentin Ligier
 **/
public class PolicyPermitWritingSecret implements ChPolicyInterface {
    public static final PolicyPermitWritingSecret INSTANCE = new PolicyPermitWritingSecret();
    ...
    @Override
    public String getId() {
        return "urn:e-health-suisse:2015:policies:permit-writing-secret";
    }
    ...
    public String getRuleId() {
        return "3438992c-fb84-46fe-9775-20cd3a24aad9";
    }
