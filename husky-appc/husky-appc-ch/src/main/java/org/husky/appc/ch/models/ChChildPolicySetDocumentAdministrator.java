 ...
 **/
public class ChChildPolicySetDocumentAdministrator extends ChChildPolicySet {
     ...
     */
    public ChChildPolicySetDocumentAdministrator(final String policySetId,
     ...
     * @param administratorId   The administrator Id.
     */
    public ChChildPolicySetDocumentAdministrator(final String id,
