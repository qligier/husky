...
import org.husky.appc.ch.policies.PolicyDenyAll;
 ...
 **/
public class PolicySetExclusionList implements ChPolicySetInterface {
    public static final PolicySetExclusionList INSTANCE = new PolicySetExclusionList();
    ...
    @Override
    public String getId() {
        return "urn:e-health-suisse:2015:policies:exclusion-list";
    }
    ...
    public List<@NonNull ChPolicyInterface> getReferencedPolicies() {
        return List.of(PolicyDenyAll.INSTANCE);
    }
