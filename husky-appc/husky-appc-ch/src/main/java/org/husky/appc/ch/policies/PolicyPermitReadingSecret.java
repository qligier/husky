...
/**
 * The referenced policy 'permit access secret'.
 *
 * @author Quentin Ligier
 **/
public class PolicyPermitReadingSecret implements ChPolicyInterface {
    public static final PolicyPermitReadingSecret INSTANCE = new PolicyPermitReadingSecret();
    ...
    @Override
    public String getId() {
        return "urn:e-health-suisse:2015:policies:permit-reading-secret";
    }
    ...
    public String getRuleId() {
        return "b5271b5b-1f82-4162-872a-6687f3d1d0e6";
    }
